        ...
        self.each(function (baseIndex, baseElem) {
            ...
            var settings = $.extend({
                ...
                'add_row': function (grid, col) {
                    ...
                    col.append(row);
                    row.append(grid.createColumn(6)).append(grid.createColumn(6));
                    grid.init();
                },
                'delete_col': function (grid, col) {
            ...
            function createTool(drawer, title, className, iconClass, eventHandlers, params) {
            ...
            subself.reset = reset;
            subself.init = init;
            subself.deinit = deinit;
            subself.createRowControls = createRowControls;
            subself.createColControls = createColControls;
            subself.createTool = createTool;
            subself.createDetails = createDetails;
            subself.addAllColClasses = addAllColClasses;
            subself.getColSize = getColSize;
            subself.getColSizes = getColSizes;
            subself.setColSize = setColSize;
            subself.makeSortable = makeSortable;
            subself.removeSortable = removeSortable;
            subself.createRow = createRow;
            subself.createColumn = createColumn;
            subself.runFilter = runFilter;
            subself.wrapContent = wrapContent;
            subself.doWrap = doWrap;
            subself.createDefaultContentWrapper = createDefaultContentWrapper;
